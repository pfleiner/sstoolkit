Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/pfleiner/sstoolkit.git', :tag => 'v1.0.4' }
  s.description  = 'SSToolkit is a collection of well-doc≈umented iOS classes for making life ' \
